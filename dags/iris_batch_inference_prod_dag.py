...
with DAG(
    dag_id="iris_batch_inference_prod",
    default_args=default_args,
    description="Batch inference using blessed Iris model (prod)",
    schedule_interval="0 8 * * *",
    start_date=datetime(2026, 1, 1),
    catchup=False,
    tags=["ml", "inference", "batch", "iris-prod"],
    params={
        ...
        "bq_table_predictions": Param("iris_predictions", type="string",
    ...
    run_inference_pipeline = KubernetesPodOperator(
        ...
        name="iris-inference-pipeline-prod",
